...
/**
 * Class that simulates a forestry database.
...
public class Forestry {
    ...
    /**
     * The main method which enters the forestry simulation program.
     *
     * @param args The command-line arguments that include the names of the forests.
     * @see Forestry
     */
